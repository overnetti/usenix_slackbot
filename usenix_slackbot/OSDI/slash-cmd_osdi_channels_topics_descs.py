...
def create_channels():
    ...
    list_of_channels = list(f.slack_channels_osdi(weblink))
...
def set_topic_desc():
    ...
    new_channels = list(f.slack_channels_osdi(weblink))
    existing_channels = client.conversations_list(limit=999)
    counter = 0
    channel_ids = []
    channel_names = []
    ...
    topic_strings = list(f.channel_topic_osdi(weblink))
    desc_strings = list(f.channel_desc_osdi(weblink))
